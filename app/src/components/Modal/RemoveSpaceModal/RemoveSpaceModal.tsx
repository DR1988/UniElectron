...
import type {RemoveSpace} from '../../MainForm/MainFormInterfaces'

import s from './../styles/ValveLineModal.css'
import CommonMoadlInterface from '../modalInterfaces'

interface Props extends RemoveSpace {
  closeModal: () => void
  resetChanges: () => void
  changeStartTime: (startTime: number) => void
  changeEndTime: (addtitionalTime: number) => void
 } 
        ...
        <div className={s.content}>
          ...
          <main>
            <div className={s.inputs} >
              ...
              <div>
                <label htmlFor="additional-time">End time</label>
                <br />
                <CustomInput
                  id="additional-time"
